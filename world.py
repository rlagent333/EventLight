...
class Intersection(object):
    def __init__(self, intersection, world, yellow_phase_time=5, yellow_phase_id=0):
        ...
        self.yellow_phase_id = [yellow_phase_id]
...
class World(object):
    ...
    def __init__(self, cityflow_config, thread_num, yellow_phase_time=5, yellow_phase_id=0):
        ...
        non_virtual_intersections = [
            i for i in self.roadnet["intersections"] if not i["virtual"] and "end" not in i["id"] and len(i['trafficLight']['lightphases']) > 1
        ]
        self.intersections = [
            Intersection(i, self, yellow_phase_time, yellow_phase_id)
